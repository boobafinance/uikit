...
var Icon$I = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: 24, height: 24, href: "/images/alife/2.png" })));
};
...
var LogoBoba = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: "/images/egg/9.png" })));
};

var LogoLive = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 44 44" }, props),
        React.createElement("image", { width: "44", height: "44", href: "/images/alife/2.png" })));
};
...
var socials = [
    {
        ...
        items: [
            ...
            {
                label: "Português",
                href: "https://t.me/boobamfinancebrcomunidade",
            },
            /*  {
              label: "Español",
            ...
            {
                label: "Price Bot",
                href: "https://t.me/boobambotprice",
            },
        ],
    },
    {
...
var InnerMenuLink = function (_a) {
    ...
    var Tag = isHttpLink ? "a" : NavLink;
    var props = isHttpLink ? { href: href } : { to: href };
    return React.createElement(Tag, __assign({}, props, otherProps, { target: "_blank", rel: "noreferrer" }));
};
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(InnerMenuLink, { href: item.href }, item.label))); })));
        }
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            BobaValue ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React.createElement(Text, { bold: true, color: "#644f30", mr: "16px", style: { fontFamily: "Lato" } }, title),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#F2ECE3", backgroundDisabled: "#E9EAEB", contrast: "#0b2b27", invertedContrast: "#FFFFFF", input: "#EDE6D8", tertiary: "#EDE6D8", text: "#B28E59", textDisabled: "#838383", textSubtle: "#B28E59", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#999", background: "#343135", backgroundDisabled: "#999", contrast: "#EDE6D8", invertedContrast: "#838383", input: "#838383", primaryDark: "#838383", tertiary: "#2E3138", text: "#EDE6D8", textDisabled: "#cccccc", textSubtle: "#EDE6D8", borderColor: "#000", card: "#27262c", gradients: {
