...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#AA7A44", textDisabled: "#BDC2C4", textSubtle: "#AA7A44", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
